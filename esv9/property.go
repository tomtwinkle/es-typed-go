...
// ---------------------------------------------------------------------------
// Exponential Histogram (v9 only)
// ---------------------------------------------------------------------------

// ExponentialHistogramPropertyOption is a functional option for configuring ExponentialHistogramProperty.
type ExponentialHistogramPropertyOption func(*types.ExponentialHistogramProperty)
