...
func assertCreateIndexSettingsApplied(t *testing.T, ctx context.Context, client esv9.ESClient, index estype.Index) {
	t.Helper()
...
func assertCreateIndexMappingApplied(t *testing.T, ctx context.Context, client esv9.ESClient, index estype.Index) {
	t.Helper()
...
func assertCreateIndexCanIndexAndReadDocument(t *testing.T, ctx context.Context, client esv9.ESClient, index estype.Index) {
	t.Helper()
