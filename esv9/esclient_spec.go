...
// ESClientSpec is the full Elasticsearch v9 API interface.
// It embeds ESClient (semantic methods) and adds spec-named pass-through
// methods for every endpoint available in the go-elasticsearch v9 client.
type ESClientSpec interface {
	...
	// ConnectorSecretDelete wraps the Elasticsearch spec endpoint connector.secret_delete.
	ConnectorSecretDelete(ctx context.Context, id string) (*connector_secret_delete.Response, error)
	// ConnectorSecretGet wraps the Elasticsearch spec endpoint connector.secret_get.
	ConnectorSecretGet(ctx context.Context, id string) (*connector_secret_get.Response, error)
	// ConnectorSecretPost wraps the Elasticsearch spec endpoint connector.secret_post.
	ConnectorSecretPost(ctx context.Context, req *connector_secret_post.Request) (*connector_secret_post.Response, error)
	// ConnectorSecretPut wraps the Elasticsearch spec endpoint connector.secret_put.
	ConnectorSecretPut(ctx context.Context, id string, req *connector_secret_put.Request) (*connector_secret_put.Response, error)
	...
	// EsqlDeleteView wraps the Elasticsearch spec endpoint esql.delete_view.
	EsqlDeleteView(ctx context.Context, name string) (*esql_delete_view.Response, error)
	// EsqlGetQuery wraps the Elasticsearch spec endpoint esql.get_query.
	EsqlGetQuery(ctx context.Context, id string) (*esql_get_query.Response, error)
	// EsqlGetView wraps the Elasticsearch spec endpoint esql.get_view.
	EsqlGetView(ctx context.Context) (*esql_get_view.Response, error)
	// EsqlListQueries wraps the Elasticsearch spec endpoint esql.list_queries.
	...
	// FleetDeleteSecret wraps the Elasticsearch spec endpoint fleet.delete_secret.
	FleetDeleteSecret(ctx context.Context, id string) (*fleet_delete_secret.Response, error)
	// FleetGetSecret wraps the Elasticsearch spec endpoint fleet.get_secret.
	FleetGetSecret(ctx context.Context, id string) (*fleet_get_secret.Response, error)
	...
	FleetPostSecret(ctx context.Context, req *fleet_post_secret.Request) (*fleet_post_secret.Response, error)
	...
	// IndicesDeleteDataStreamOptions wraps the Elasticsearch spec endpoint indices.delete_data_stream_options.
	IndicesDeleteDataStreamOptions(ctx context.Context, name string) (*indices_delete_data_stream_options.Response, error)
	...
	// IndicesGetDataStreamMappings wraps the Elasticsearch spec endpoint indices.get_data_stream_mappings.
	IndicesGetDataStreamMappings(ctx context.Context, name string) (*indices_get_data_stream_mappings.Response, error)
	// IndicesGetDataStreamOptions wraps the Elasticsearch spec endpoint indices.get_data_stream_options.
	IndicesGetDataStreamOptions(ctx context.Context, name string) (*indices_get_data_stream_options.Response, error)
	// IndicesGetDataStreamSettings wraps the Elasticsearch spec endpoint indices.get_data_stream_settings.
	IndicesGetDataStreamSettings(ctx context.Context, name string) (*indices_get_data_stream_settings.Response, error)
	...
	// IndicesPutDataStreamMappings wraps the Elasticsearch spec endpoint indices.put_data_stream_mappings.
	IndicesPutDataStreamMappings(ctx context.Context, name string, req *indices_put_data_stream_mappings.Request) (*indices_put_data_stream_mappings.Response, error)
	// IndicesPutDataStreamOptions wraps the Elasticsearch spec endpoint indices.put_data_stream_options.
	IndicesPutDataStreamOptions(ctx context.Context, name string, req *indices_put_data_stream_options.Request) (*indices_put_data_stream_options.Response, error)
	// IndicesPutDataStreamSettings wraps the Elasticsearch spec endpoint indices.put_data_stream_settings.
	IndicesPutDataStreamSettings(ctx context.Context, name string, req *indices_put_data_stream_settings.Request) (*indices_put_data_stream_settings.Response, error)
	...
	// IndicesRemoveBlock wraps the Elasticsearch spec endpoint indices.remove_block.
	IndicesRemoveBlock(ctx context.Context, index string, block string) (*indices_remove_block.Response, error)
	...
	IndicesResolveIndex(ctx context.Context, name string, req *indices_resolve_index.Request) (*indices_resolve_index.Response, error)
	...
	IndicesSimulateIndexTemplate(ctx context.Context, name string, req *indices_simulate_index_template.Request) (*indices_simulate_index_template.Response, error)
	...
	// InferencePutAi21 wraps the Elasticsearch spec endpoint inference.put_ai21.
	InferencePutAi21(ctx context.Context, tasktype string, ai21inferenceid string, req *inference_put_ai21.Request) (*inference_put_ai21.Response, error)
	...
	// InferencePutContextualai wraps the Elasticsearch spec endpoint inference.put_contextualai.
	InferencePutContextualai(ctx context.Context, tasktype string, contextualaiinferenceid string, req *inference_put_contextualai.Request) (*inference_put_contextualai.Response, error)
	...
	// InferencePutGroq wraps the Elasticsearch spec endpoint inference.put_groq.
	InferencePutGroq(ctx context.Context, tasktype string, groqinferenceid string, req *inference_put_groq.Request) (*inference_put_groq.Response, error)
	...
	// InferencePutLlama wraps the Elasticsearch spec endpoint inference.put_llama.
	InferencePutLlama(ctx context.Context, tasktype string, llamainferenceid string, req *inference_put_llama.Request) (*inference_put_llama.Response, error)
	...
	// InferencePutNvidia wraps the Elasticsearch spec endpoint inference.put_nvidia.
	InferencePutNvidia(ctx context.Context, tasktype string, nvidiainferenceid string, req *inference_put_nvidia.Request) (*inference_put_nvidia.Response, error)
	...
	// InferencePutOpenshiftAi wraps the Elasticsearch spec endpoint inference.put_openshift_ai.
	InferencePutOpenshiftAi(ctx context.Context, tasktype string, openshiftaiinferenceid string, req *inference_put_openshift_ai.Request) (*inference_put_openshift_ai.Response, error)
	...
	ProfilingFlamegraph(ctx context.Context, req *profiling_flamegraph.Request) (profiling_flamegraph.Response, error)
	// ProfilingStacktraces wraps the Elasticsearch spec endpoint profiling.stacktraces.
	ProfilingStacktraces(ctx context.Context, req *profiling_stacktraces.Request) (profiling_stacktraces.Response, error)
	...
	// SecurityGetStats wraps the Elasticsearch spec endpoint security.get_stats.
	SecurityGetStats(ctx context.Context) (*security_get_stats.Response, error)
	...
	StreamsLogsDisable(ctx context.Context) (*streams_logs_disable.Response, error)
	// StreamsLogsEnable wraps the Elasticsearch spec endpoint streams.logs_enable.
	StreamsLogsEnable(ctx context.Context) (*streams_logs_enable.Response, error)
	// StreamsStatus wraps the Elasticsearch spec endpoint streams.status.
	StreamsStatus(ctx context.Context) (*streams_status.Response, error)
	...
	TransformGetNodeStats(ctx context.Context) (*transform_get_node_stats.Response, error)
	...
	// TransformSetUpgradeMode wraps the Elasticsearch spec endpoint transform.set_upgrade_mode.
	TransformSetUpgradeMode(ctx context.Context) (*transform_set_upgrade_mode.Response, error)
