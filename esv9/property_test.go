...
func TestNewKeywordProperty(t *testing.T) {
	t.Parallel()
	prop := esv9.NewKeywordProperty(256)
	assert.Assert(t, prop != nil)
...
func TestNewTextProperty(t *testing.T) {
	...
	t.Run("without raw keyword", func(t *testing.T) {
		t.Parallel()
		prop := esv9.NewTextProperty(nil)
		assert.Assert(t, prop != nil)
	})

	t.Run("with raw keyword", func(t *testing.T) {
		t.Parallel()
		prop := esv9.NewTextProperty(&estype.RawKeyword{IgnoreAbove: 256})
		assert.Assert(t, prop != nil)
...
func TestNewDateProperty(t *testing.T) {
	...
	t.Run("with format", func(t *testing.T) {
		t.Parallel()
		prop := esv9.NewDateProperty(estype.DateFormatStrictDate)
		assert.Assert(t, prop != nil)
	...
	t.Run("with multiple formats", func(t *testing.T) {
		t.Parallel()
		prop := esv9.NewDateProperty(estype.DateFormatStrictDateOptionalTime, estype.DateFormatEpochMillis)
		assert.Assert(t, prop != nil)
		assert.Assert(t, prop.Format != nil)
...
func TestNewNestedProperty(t *testing.T) {
	...
	nestedMapping.Properties = map[string]types.Property{
		"name": esv9.NewKeywordProperty(256),
	}
	prop := esv9.NewNestedProperty(nestedMapping)
	assert.Assert(t, prop != nil)
