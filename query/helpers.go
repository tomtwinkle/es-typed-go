// Package query provides a version-agnostic fluent query DSL for Elasticsearch.
// It uses go-elasticsearch/v8 types internally; SearchParams implements both
// ToV8Request and ToV9Request so it can be passed directly to either
// esv8.Search or esv9.Search without modification.
package query
