...
func TestNewPassthroughObjectProperty_Options(t *testing.T) {
	...
	t.Run("with options", func(t *testing.T) {
		...
		prop := esv8.NewPassthroughObjectProperty(
			...
			esv8.WithPassthroughObjectStore(true),
