...
// CatCircuitBreakerOption is reserved for future use. CatCircuitBreaker is not
// available in the Elasticsearch v8 TypedAPI and the option has no effect.
type CatCircuitBreakerOption func()
